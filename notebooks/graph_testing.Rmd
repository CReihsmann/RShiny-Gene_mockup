...
nhp$celltype <- factor(nhp$celltype, levels = rev(level_order))
...
nhp %>% 
  ...
  geom_label(data = annotation, aes(x = c(1, 5), y = c(0, 0), label = 'Celltype not classified'), hjust = 'left', fill = 'white', fontface = 'bold')
